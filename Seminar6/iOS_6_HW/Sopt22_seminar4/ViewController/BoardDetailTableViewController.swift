...
class BoardDetailTableViewController: UIViewController,UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var commentWriteViewConstraint: NSLayoutConstraint!
    ...
    func commentInit() {
        ...
        let URL = "http://13.124.143.2:3009/comment/\(idx)"
    ...
    func saveComment(content: String, password: String) {
        ...
        let URL = "http://13.124.143.2:3009/comment"
...
extension BoardDetailTableViewController {
    ...
    @objc func keyboardWillShow(_ notification: Notification) {
        ...
        if let keyboardSize = (notification.userInfo?[UIKeyboardFrameEndUserInfoKey] as? NSValue)?.cgRectValue {
            ...
            if check {
                constraintInitVal = commentWriteViewConstraint.constant
                commentWriteViewConstraint.constant += keyboardSize.height
    ...
    @objc func keyboardWillHide(_ notification: Notification) {
        ...
        if let keyboardSize = (notification.userInfo?[UIKeyboardFrameEndUserInfoKey] as? NSValue)?.cgRectValue {
            ...
            commentWriteViewConstraint.constant = constraintInitVal
            //commentSendView.frame.origin.y += keyboardSize.height
            ////////
            self.view.layoutIfNeeded()
            check = true
